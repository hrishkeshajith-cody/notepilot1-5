          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                size="lg" 
                className="rounded-full px-8 gradient-primary text-primary-foreground shadow-glow hover:opacity-90 transition-opacity"
              >
                Get Started Free
          ...
          >
            <div className="bg-card border rounded-2xl shadow-soft p-8 max-w-4xl mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {['Summary', 'Notes', 'Flashcards', 'Quiz'].map((tab, i) => (
                  <div
                    key={tab}
                    className={`p-4 rounded-xl text-center transition-all ${
                      i === 0 ? 'bg-primary text-primary-foreground shadow-glow' : 'bg-muted text-muted-foreground hover:bg-secondary'
                    }`}
                  >
